...
#define MVAR_INVENTORY_HOSTID				MVAR_INVENTORY "HOSTID}"
#define MVAR_INVENTORY_INVENTORY_MODE		MVAR_INVENTORY "INVENTORY.MODE}"
#define MVAR_INVENTORY_DUNIQUE_TYPE			MVAR_INVENTORY "DUNIQUE.TYPE}"
#define MVAR_INVENTORY_DUNIQUE				MVAR_INVENTORY "DUNIQUE}"
#define MVAR_INVENTORY_HOUSEID				MVAR_INVENTORY "HOUSEID}"
#define MVAR_INVENTORY_INVENTORY_TYPEID		MVAR_INVENTORY "INVENTORY.TYPEID}"
#define MVAR_INVENTORY_MANAGERID			MVAR_INVENTORY "MANAGERID}"
#define MVAR_INVENTORY_HOSTGROUPID			MVAR_INVENTORY "HOSTGROUPID}"
#define MVAR_INVENTORY_GROUPID				MVAR_INVENTORY "GROUPID}"
#define MVAR_INVENTORY_MANUFACTURER			MVAR_INVENTORY "MANUFACTURER}"
#define MVAR_INVENTORY_PHYSICAL_MODEL		MVAR_INVENTORY "PHYSICAL.MODEL}"
#define MVAR_INVENTORY_PHYSICAL_SERIAL		MVAR_INVENTORY "PHYSICAL.SERIAL}"
#define MVAR_INVENTORY_CHASSIS				MVAR_INVENTORY "CHASSIS}"
#define MVAR_INVENTORY_CHASSIS_SERIAL		MVAR_INVENTORY "CHASSIS.SERIAL}"
#define MVAR_INVENTORY_BOARD				MVAR_INVENTORY "BOARD}"
#define MVAR_INVENTORY_BOARD_SERIAL			MVAR_INVENTORY "BOARD.SERIAL}"
#define MVAR_INVENTORY_OS_SHORT				MVAR_INVENTORY "OS.SHORT}"
#define MVAR_INVENTORY_IP					MVAR_INVENTORY "IP}"
#define MVAR_INVENTORY_NAME					MVAR_INVENTORY "NAME}"
#define MVAR_INVENTORY_DESCRIPTION			MVAR_INVENTORY "DESCRIPTION}"
#define MVAR_INVENTORY_CPU					MVAR_INVENTORY "CPU}"
#define MVAR_INVENTORY_MEMORY				MVAR_INVENTORY "MEMORY}"
#define MVAR_INVENTORY_DISK					MVAR_INVENTORY "DISK}"
#define MVAR_INVENTORY_NETWORK				MVAR_INVENTORY "NETWORK}"
#define MVAR_INVENTORY_BIOS					MVAR_INVENTORY "BIOS}"
#define MVAR_INVENTORY_PSU					MVAR_INVENTORY "PSU}"
#define MVAR_INVENTORY_ASSETS_CODE			MVAR_INVENTORY "ASSETS.CODE}"
#define MVAR_INVENTORY_PURCHASE_DATE		MVAR_INVENTORY "PURCHASE_DATE}"
#define MVAR_INVENTORY_PURCHASE_PRICE		MVAR_INVENTORY "PURCHASE.PRICE}"
#define MVAR_INVENTORY_PURCHASE_ORDER_NO	MVAR_INVENTORY "PURCHASE.ORDER.NO}"
#define MVAR_INVENTORY_MAINT_DAYS			MVAR_INVENTORY "MAINT.DAYS}"
...
{
	MVAR_INVENTORY_HOSTID,MVAR_INVENTORY_INVENTORY_MODE,MVAR_INVENTORY_DUNIQUE_TYPE,
	MVAR_INVENTORY_DUNIQUE,MVAR_INVENTORY_HOUSEID,MVAR_INVENTORY_INVENTORY_TYPEID,
	MVAR_INVENTORY_MANAGERID,MVAR_INVENTORY_HOSTGROUPID,MVAR_INVENTORY_GROUPID,
	MVAR_INVENTORY_MANUFACTURER,MVAR_INVENTORY_PHYSICAL_MODEL,MVAR_INVENTORY_PHYSICAL_SERIAL,
	MVAR_INVENTORY_CHASSIS,MVAR_INVENTORY_CHASSIS_SERIAL,MVAR_INVENTORY_BOARD,
	MVAR_INVENTORY_BOARD_SERIAL,MVAR_INVENTORY_OS_SHORT,MVAR_INVENTORY_IP,
	MVAR_INVENTORY_NAME,MVAR_INVENTORY_DESCRIPTION,MVAR_INVENTORY_CPU,MVAR_INVENTORY_MEMORY,
	MVAR_INVENTORY_DISK,MVAR_INVENTORY_NETWORK,MVAR_INVENTORY_BIOS,MVAR_INVENTORY_PSU,
	MVAR_INVENTORY_ASSETS_CODE,MVAR_INVENTORY_PURCHASE_DATE,MVAR_INVENTORY_PURCHASE_PRICE,
	MVAR_INVENTORY_PURCHASE_ORDER_NO,MVAR_INVENTORY_MAINT_DAYS,
	/* PROFILE.* is deprecated, use INVENTORY.* instead */
...
static inventory_field_t	inventory_fields[] =
{
	...
	{MVAR_INVENTORY_HOSTID, 0},
	{MVAR_INVENTORY_INVENTORY_MODE, 1},
	{MVAR_INVENTORY_DUNIQUE_TYPE, 2},
	{MVAR_INVENTORY_DUNIQUE, 3},
	{MVAR_INVENTORY_HOUSEID, 4},
	{MVAR_INVENTORY_INVENTORY_TYPEID, 5},
	{MVAR_INVENTORY_MANAGERID, 6},
	{MVAR_INVENTORY_HOSTGROUPID, 7},
	{MVAR_INVENTORY_GROUPID, 8},
	{MVAR_INVENTORY_MANUFACTURER, 9},
	{MVAR_INVENTORY_PHYSICAL_MODEL, 10},
	{MVAR_INVENTORY_PHYSICAL_SERIAL, 11},
	{MVAR_PROFILE_SERIALNO, 11},     	/* deprecated */
	{MVAR_INVENTORY_CHASSIS, 12},
	{MVAR_INVENTORY_CHASSIS_SERIAL, 13},
	{MVAR_INVENTORY_BOARD, 14},
	{MVAR_INVENTORY_BOARD_SERIAL, 15},
	{MVAR_INVENTORY_OS_SHORT, 16},
	{MVAR_INVENTORY_IP, 17},
	{MVAR_INVENTORY_NAME, 18},
	{MVAR_PROFILE_NAME, 18},	/* deprecated */
	{MVAR_INVENTORY_DESCRIPTION, 19},
	{MVAR_PROFILE_OS, 19},		/* deprecated */
	{MVAR_INVENTORY_CPU, 20},
	{MVAR_INVENTORY_MEMORY, 21},
	{MVAR_INVENTORY_DISK, 22},
	{MVAR_INVENTORY_NETWORK, 23},
	{MVAR_INVENTORY_BIOS, 24},
	{MVAR_INVENTORY_PSU, 25},
	{MVAR_INVENTORY_ASSETS_CODE, 26},
	{MVAR_INVENTORY_PURCHASE_DATE, 27},
	{MVAR_INVENTORY_PURCHASE_PRICE, 28},
	{MVAR_INVENTORY_PURCHASE_ORDER_NO, 29},
	{MVAR_INVENTORY_MAINT_DAYS, 30},
	{NULL}
};
