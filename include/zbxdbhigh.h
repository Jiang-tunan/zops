...
#define ZBX_DSERVICE_KEY_ENTPHYSICALSERIALNUM   "{#ENTPHYSICALSERIALNUM}"
#define ZBX_DSERVICE_KEY_SYSDESC                "{#SYSDESC}"
#define ZBX_DSERVICE_KEY_SYSNAME                "{#SYSNAME}"
#define ZBX_DSERVICE_KEY_IFPHYSADDRESS          "{#IFPHYSADDRESS}"
#define ZBX_DSERVICE_KEY_ENTPHYSICALMODELNAME   "{#ENTPHYSICALMODELNAME}"

#define ZBX_DSERVICE_ILLEGAL_MACADDRS           "00-00-00-00-00-00"
#define ZBX_DSERVICE_ILLEGAL_MACADDRS_LEN       17

#define ZBX_DSERVICE_VALUE_LEN		4096
...
/* condition types */
#define ZBX_CONDITION_TYPE_HOST_GROUP			0        //主机群组
#define ZBX_CONDITION_TYPE_HOST				1            //主机
...
#define ZBX_CONDITION_TYPE_HOST_HOUSE			29        //机房
#define ZBX_CONDITION_TYPE_HOST_IDC			    30        //数据中心
